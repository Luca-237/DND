...
export const SPELLS = {
    ...
    cantrips: [
        ...
        { id: 'vicious_mockery', name: 'Burla Cruel', level: 0, lists: ['bard'], school: 'Encantamiento', castTime: 'Acción', range: '60 pies', duration: 'Instantáneo', description: 'Desatas una cadena de insultos mágicos. El objetivo debe hacer una salvación de SAB o recibe 1d6 psíquico y tiene desventaja en su próximo ataque.', damage: '1d6' },
        ...
        { id: 'sacred_flame', name: 'Llama Sagrada', level: 0, lists: ['cleric'], school: 'Evocación', castTime: 'Acción', range: '60 pies', duration: 'Instantáneo', description: 'Llamas descienden sobre una criatura. Salvación de DES o 1d8 radiante. Ignora cobertura.', damage: '1d8' },
        ...
        { id: 'toll_the_dead', name: 'Tañido de Muerte', level: 0, lists: ['cleric', 'warlock', 'wizard'], school: 'Nigromancia', castTime: 'Acción', range: '60 pies', duration: 'Instantáneo', description: 'Salvación de SAB o 1d8 necrótico (1d12 si ya está herido).', damage: '1d12' },
        { id: 'word_of_radiance', name: 'Palabra Radiante', level: 0, lists: ['cleric'], school: 'Evocación', castTime: 'Acción', range: '5 pies', duration: 'Instantáneo', description: 'Cada criatura elegida a 5 pies: salvación de CON o 1d6 radiante.', damage: '1d6' },
        ...
        { id: 'produce_flame', name: 'Producir Llama', level: 0, lists: ['druid'], school: 'Conjuración', castTime: 'Acción', range: 'Personal / 30 pies', duration: '10 minutos', description: 'Una llama aparece en tu mano (ilumina 20 pies). Puedes lanzarla: ataque ranged, 1d8 fuego.', damage: '1d8' },
        { id: 'shillelagh', name: 'Shillelagh', level: 0, lists: ['druid'], school: 'Transmutación', castTime: 'Acción Adicional', range: 'Toque', duration: '1 minuto', description: 'Un bastón o garrote usa tu aptitud mágica para ataque y daño, y su dado de daño es 1d8.', damage: '1d8' },
        { id: 'thorn_whip', name: 'Látigo de Espinas', level: 0, lists: ['druid'], school: 'Transmutación', castTime: 'Acción', range: '30 pies', duration: 'Instantáneo', description: 'Ataque de conjuro a distancia. 1d6 perforante y arrastras al objetivo 10 pies hacia ti.', damage: '1d6' },

        // --- Hechicero/Mago/Brujo ---
        { id: 'acid_splash', name: 'Salpicadura de Ácido', level: 0, lists: ['sorcerer', 'wizard'], school: 'Evocación', castTime: 'Acción', range: '60 pies', duration: 'Instantáneo', description: 'Lanzas una burbuja de ácido. 1 o 2 criaturas adyacentes: salvación de DES o 1d6 ácido.', damage: '1d6' },
        { id: 'chill_touch', name: 'Toque Gélido', level: 0, lists: ['sorcerer', 'warlock', 'wizard'], school: 'Nigromancia', castTime: 'Acción', range: '120 pies', duration: '1 asalto', description: 'Ataque de conjuro a distancia. 1d10 necrótico y el objetivo no puede recuperar PG hasta tu próximo turno.', damage: '1d10' },
        { id: 'eldritch_blast', name: 'Rayo Místico', level: 0, lists: ['warlock'], school: 'Evocación', castTime: 'Acción', range: '120 pies', duration: 'Instantáneo', description: 'Lanzas un rayo de energía. Ataque de conjuro a distancia, 1d10 de fuerza. Rayos adicionales a niveles superiores.', damage: '1d10' },
        { id: 'fire_bolt', name: 'Descarga de Fuego', level: 0, lists: ['sorcerer', 'wizard'], school: 'Evocación', castTime: 'Acción', range: '120 pies', duration: 'Instantáneo', description: 'Lanzas un dardo de fuego. Ataque de conjuro a distancia, 1d10 de fuego.', damage: '1d10' },
        { id: 'poison_spray', name: 'Rociada de Veneno', level: 0, lists: ['druid', 'sorcerer', 'warlock', 'wizard'], school: 'Nigromancia', castTime: 'Acción', range: '30 pies', duration: 'Instantáneo', description: 'Exhalas una nube de gas venenoso. Salvación de CON o 1d12 veneno.', damage: '1d12' },
        { id: 'ray_of_frost', name: 'Rayo de Escarcha', level: 0, lists: ['sorcerer', 'wizard'], school: 'Evocación', castTime: 'Acción', range: '60 pies', duration: 'Instantáneo', description: 'Rayo gélido. Ataque de conjuro a distancia, 1d8 frío y -10 pies velocidad.', damage: '1d8' },
        { id: 'shocking_grasp', name: 'Agarre Electrizante', level: 0, lists: ['sorcerer', 'wizard'], school: 'Evocación', castTime: 'Acción', range: 'Toque', duration: 'Instantáneo', description: 'Ataque de conjuro cuerpo a cuerpo, 1d8 relámpago. Ventaja si lleva armadura metálica.', damage: '1d8' },
    ],
    ...
    level1: [
        ...
        { id: 'cure_wounds', name: 'Curar Heridas', level: 1, lists: ['bard', 'cleric', 'druid', 'paladin', 'ranger'], school: 'Evocación', castTime: 'Acción', range: 'Toque', duration: 'Instantáneo', description: 'Curas 2d8 + mod aptitud mágica PG al tocar a una criatura.', healing: '2d8' },
        { id: 'dissonant_whispers', name: 'Susurros Disonantes', level: 1, lists: ['bard'], school: 'Encantamiento', castTime: 'Acción', range: '60 pies', duration: 'Instantáneo', description: 'Susurras una melodía disonante. Salvación de SAB: 3d6 psíquico y debe huir (mitad y no huye en éxito).', damage: '3d6' },
        ...
        { id: 'healing_word', name: 'Palabra Sanadora', level: 1, lists: ['bard', 'cleric', 'druid'], school: 'Evocación', castTime: 'Acción Adicional', range: '60 pies', duration: 'Instantáneo', description: 'Una criatura que puedas ver recupera 2d4 + mod aptitud mágica PG.', healing: '2d4' },
        ...
        { id: 'thunderwave', name: 'Onda Atronadora', level: 1, lists: ['bard', 'druid', 'sorcerer', 'wizard'], school: 'Evocación', castTime: 'Acción', range: 'Personal (cubo 15 pies)', duration: 'Instantáneo', description: 'Una onda de fuerza atronadora surge de ti. Salvación de CON: 2d8 trueno y empujadas 10 pies (mitad sin empuje).', damage: '2d8' },
        ...
        { id: 'guiding_bolt', name: 'Rayo Guía', level: 1, lists: ['cleric'], school: 'Evocación', castTime: 'Acción', range: '120 pies', duration: '1 asalto', description: 'Ataque de conjuro a distancia. 4d6 radiante. El siguiente ataque contra el objetivo tiene ventaja.', damage: '4d6' },
        { id: 'inflict_wounds', name: 'Infligir Heridas', level: 1, lists: ['cleric'], school: 'Nigromancia', castTime: 'Acción', range: 'Toque', duration: 'Instantáneo', description: 'Ataque de conjuro cuerpo a cuerpo. 2d10 necrótico.', damage: '2d10' },
        ...
        { id: 'goodberry', name: 'Bayas Mágicas', level: 1, lists: ['druid', 'ranger'], school: 'Conjuración', castTime: 'Acción', range: 'Toque', duration: 'Instantáneo', description: 'Creas 10 bayas mágicas. Cada una cura 1 PG y nutre por un día.', healing: '10' },
        ...
        // --- Mago ---
        { id: 'burning_hands', name: 'Manos Ardientes', level: 1, lists: ['sorcerer', 'wizard'], school: 'Evocación', castTime: 'Acción', range: 'Personal (cono 15 pies)', duration: 'Instantáneo', description: 'Llamas surgen de tus manos en un cono. Salvación de DES: 3d6 fuego (mitad en éxito).', damage: '3d6' },
        ...
        { id: 'magic_missile', name: 'Proyectil Mágico', level: 1, lists: ['sorcerer', 'wizard'], school: 'Evocación', castTime: 'Acción', range: '120 pies', duration: 'Instantáneo', description: 'Tres dardos de fuerza mágica impactan automáticamente. Cada uno hace 1d4+1 de fuerza.', damage: '3d4' },
        ...
        { id: 'witch_bolt', name: 'Descarga de Bruja', level: 1, lists: ['sorcerer', 'warlock', 'wizard'], school: 'Evocación', castTime: 'Acción', range: '60 pies', duration: 'Concentración, 1 min', description: 'Ataque de conjuro a distancia. 2d12 relámpago. Turnos siguientes: 1d12 automático.', damage: '2d12' },
        ...
        // --- Paladín ---
        { id: 'divine_smite', name: 'Castigo Divino', level: 1, lists: ['paladin'], school: 'Evocación', castTime: 'Acción Adicional (al impactar)', range: 'Personal', duration: 'Instantáneo', description: 'Al impactar con un ataque cuerpo a cuerpo, añades 2d8 radiante (+1d8 si es muerto viviente o demonio).', damage: '2d8' },
